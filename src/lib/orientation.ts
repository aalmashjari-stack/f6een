 ...
 * وفيه كتابة، فيُقفل الطوليّ على الآيفون (الآيباد حرّ — الإضافة تستثنيه).
 * ومن البدء الشاشةُ عريضة (SPEC §١) فيُقفل الأفقيّ — والتطبيق يدير الجهاز
 * بنفسه في الحالين، لا بوّابة «أدر جهازك».
 *
