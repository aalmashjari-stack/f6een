...
/**
 * اختيار التصنيف — بديل العجلة، وهو اليوم للديربي وحده (القسم ٧).
 * بطاقة لكل تصنيف والضوء يلفّ عليها ثم يستقرّ.
 *
...
export function CategoryPicker({
  ...
  /**
   * تبدأ السحبةُ وحدها بلا ضغطة (قرار علي في ٢٤ أغسطس ٢٠٢٦): الحكم يعود إلى
   * الفئات بعد كل تنقيط، أربع مرّات أو أكثر في المرحلة، فالضغطة تتكرّر بلا أن
   * تحمل قراراً — السحبةُ عشوائية والحكم لا يملك منها شيئاً.
   *
   * وهي اليوم دائماً `true`: الديربي هو المرحلة الوحيدة الباقية للعجلة بعد أن
   * صار لوحُ الجولة الجماعية مختاراً من الفريقين. تبقى الخيارَ لا الحال حتى
   * لا يُدفن السلوكُ الآخر في الشيفرة لو عادت مرحلةٌ تسحب بضغطة.
   */
  auto?: boolean
}) {
