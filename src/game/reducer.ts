...
/** كم ورقةً تُضاف حين ينفد طابور الحق ما تلحق — دفعةٌ صغيرة لا ستّون: ما يُسحب هنا نادرٌ أصلاً. */
const S3_REFILL = 10

/**
 * الطابور لا ينفد. الستّون التي تُسحب عند الإنشاء تكفي دورين عاديّين
 * (١٥–٢١ لكلّ فريق)، لكنّ حكماً سريع الضغط مع فريقٍ يعرف الإجابات قد يمرّ
 * ثلاثين سؤالاً في خمسٍ وأربعين ثانية — فينتهي الفريق الثاني إلى «نفد الطابور»
