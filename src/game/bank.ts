...
/**
 * الفئات الصالحة للّعب — **ما اكتملت صفوف لوحها كلُّها وحده**
 * (`BOARD_LEVELS`). تدخل عجلةَ الديربي وقائمةَ اختيار لوح الجولة الجماعية معاً.
 *
 * السحب يقع على (فئة، مستوى). ففئةٌ بلا سؤال «صعب» تُسقط اللعبة عند خليّتها
 * الصعبة في لوح الجولة الجماعية: `drawOne` يعود من مجموعة فارغة بلا سؤال.
 * وهي كذلك قائمةُ الاختيار في الإعداد — اللوح يأخذ من كل فئةٍ صفوفَه كلَّها.
 *
