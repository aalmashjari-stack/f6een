...
/* صفوف اللوح المعروضة. **«تعجيزي» ليس فيها بعد** وإن كان مستوىً في
   `Level` وفي القاعدة: إضافتُه هنا قبل امتلاء خاناته تُسقط الفئات كلَّها
   من `playableCategories` فيصير اللوح فارغاً. يُضاف حين يبلغ كلُّ تصنيفٍ
   عشرين سؤالاً تعجيزيّاً. */
