...
/* صفوف اللوح الأربعة. **دخل «تعجيزي» في ٩ سبتمبر ٢٠٢٦** بعد أن بلغ كلُّ
...
/* خمسٌ وأربعون لا ستّون (قرار علي ٩ سبتمبر ٢٠٢٦): اللوح صار أربعة صفوفٍ
   ...
   من أثقل جزءٍ في الجلسة — وانتظارُ الفريق الصامت يقفز من 11.7 إلى 15.6
   دقيقة، وهناك يسكن الملل لا في تكرار الأسئلة. وخفضُ ربع الدقيقة عن أربعةٍ
 ...
 * المسجَّلة في `s2Pairs`. **وفي اللعب الحقيقيّ لا يتكرّر زوجٌ أبداً**: الإعداد
 * لا يقبل أقلّ من لاعبَين في الفريق، فالأزواج ≥ ٢×الأكبر ≥ عدد الجولات
 * (يُفحص لكلّ حجمٍ ٢–٦ في `session-flow.test.ts`). والعودة على الدورة حين
 * تنفد الأزواج حارسٌ ضدّ السقوط لحالةٍ لا يصنعها الإعداد (١×١).
 *
