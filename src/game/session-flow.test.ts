...
/**
 * قوانين ٤ سبتمبر ٢٠٢٦: الديربي **بلا اختيار تصنيف**، والحق ما تلحق **من
 * البنك المشحون وحده** لا مما أضافته اللوحة. وكان الديربي كذلك حتى ١٥ سبتمبر،
 * ثمّ فُتح على فئاتٍ بعينها من القاعدة بمستويي سهل ومتوسط (SPEC ٥) —
 * والفئات تصل مع المزامنة، فبلا قائمة يبقى على قانونه القديم.
 *
...
describe('الديربي والحق ما تلحق — مصدر الأسئلة', () => {
  ...
  it('الديربي بقائمة فئات: سهل ومتوسط من فئاته وحدها — مشحونةً ومضافة', () => {
    ...
    try {
      ...
      /* والمضافة تُسحب فعلاً لا تُستثنى: في ستّين جلسة تظهر الفئتان. */
  ...
  it('الحق ما تلحق لا يسحب مضافاً مهما امتلأت الطبقة — والديربي بلا قائمة كذلك', () => {
