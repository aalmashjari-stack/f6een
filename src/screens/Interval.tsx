...
const NEXT: Record<string, { title: string; rule: string }> = {
  'stage2-selection': {
    title: 'راس براس',
    rule: 'قاعدة الصمت: لا تشاور، الزملاء لا يتدخّلون. الصمت مجاني، والتخمين الخاطئ يخصم ١٠.',
  },
  'stage3-play': {
    title: 'الحق ما تلحق',
    rule: 'الساعة لا تتوقف — ٣٠ ثانية لكل فريق. كل ضغطة تكلّف وقتاً. ٥ نقاط لكل إجابة، والتمرير غير محدود.',
  },
}
